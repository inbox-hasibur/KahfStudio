...
const Footer = () => {
  ...
  return (
    <footer className="border-t border-border bg-card/80 backdrop-blur supports-[backdrop-filter]:bg-card/60 mt-8 sm:mt-12 text-left notranslate">
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 md:px-8 py-8 sm:py-12 md:py-16">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 md:gap-12">
          
          <div className="col-span-2 md:col-span-1 flex flex-col items-start">
            <Link href="/" className="flex items-center justify-start gap-2 mb-3">
              <div className="w-7 h-7 sm:w-8 sm:h-8 bg-gradient-to-br from-primary to-primary/60 rounded-xl flex items-center justify-center shadow-lg">
                <span className="text-xs sm:text-[14px] font-black text-white italic">K</span>
              </div>
              <span className="text-lg sm:text-xl font-black tracking-tighter text-foreground">
                Kahf<span className="text-primary">News</span>
              </span>
            </Link>
            <p className="text-xs sm:text-sm text-muted-foreground mb-4 max-w-xs leading-relaxed">
          ...
          <div>
            <h3 className="text-xs sm:text-sm font-bold text-foreground mb-3">রিসোর্স</h3>
            <ul className="space-y-2 text-xs sm:text-sm text-muted-foreground">
          ...
          <div>
            <h3 className="text-xs sm:text-sm font-bold text-foreground mb-3">কোম্পানি</h3>
            <ul className="space-y-2 text-xs sm:text-sm text-muted-foreground">
        ...
        <div className="mt-8 sm:mt-12 pt-6 sm:pt-8 border-t border-border flex flex-col sm:flex-row items-center justify-between gap-3 text-xs sm:text-sm text-muted-foreground">
