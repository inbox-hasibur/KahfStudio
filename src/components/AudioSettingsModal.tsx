  ...
  const models = [
    {
      ...
      name: "Gemini 3.1 Flash TTS Engine",
      tag: "Recommended / AI Studio",
      desc: "Ultra-natural expressive AI voice narration generated by Gemini.",
      badge: "Gemini AI",
    },
    {
      id: "browser-native",
      name: "Device Native WebSpeech Engine",
      tag: "Device Offline / Instant",
      desc: "Built-in device speech synthesis engine for instant zero-latency playback.",
      badge: "Device Native",
    },
    {
      id: "microsoft-online",
