...
export default function AudioSettingsModal({ isOpen, onClose }: AudioSettingsModalProps) {
  ...
  const models = [
    {
      id: "browser-native",
      name: "Device Native Speech Engine",
      tag: "Recommended / Zero Latency",
      desc: "Built-in speech synthesis engine for instant zero-latency playback across all articles without rate limits.",
      badge: "Fast & Reliable",
    },
    {
      id: "gemini-3.1-flash-tts",
      name: "Gemini 3.1 Flash AI Audio",
      tag: "Daily Podcast & Pre-rendered",
      desc: "Studio-grade neural AI voice engine used for Daily AI Podcasts and pre-rendered Cloudinary audio tracks.",
      badge: "AI Studio",
    },
    {
      id: "microsoft-online",
      name: "Microsoft / Natural Speech",
      tag: "Online System Voices",
      desc: "Enhanced natural clarity system voices with authentic cadence and pronunciation.",
      badge: "Natural Speech",
    },
  ];

  const voices = [
    { id: "radio-host", name: "রেডিও উপস্থাপক (Radio Host)", gender: "male", desc: "Energy & Broadcast clarity (Male default)" },
    { id: "studio-deep", name: "ডিপ ভয়েস (Studio Deep)", gender: "male", desc: "Deep authoritative documentary tone (Male)" },
